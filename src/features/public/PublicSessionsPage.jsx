...
const sessionHighlights = [
  {
    title: 'Doctor',
    description: 'Reviews assessment results, adjusts treatment direction, and confirms the next clinical step.',
    icon: Stethoscope,
  },
  {
    title: 'Therapist',
...
const realConnectionPoints = [
  ...
  'Assessments and reports connect therapist observations to doctor review.',
