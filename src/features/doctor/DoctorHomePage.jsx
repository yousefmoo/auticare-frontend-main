...
import { doctorPatients, parentWeeklySchedule, screeningQueue } from '../dashboard/mockData'
...
export default function DoctorHomePage() {
  ...
  return (
    <div className="fade-in space-y-6">
      <section className="rounded-[2rem] bg-gradient-to-r from-blue-900 via-blue-800 to-sky-700 p-6 text-white shadow-2xl sm:p-8">
        <div className="flex flex-col gap-4 xl:flex-row xl:items-center xl:justify-between">
          <div className="space-y-3">
            ...
            <div>
              <h1 className="text-3xl font-bold sm:text-4xl">Clinical home overview</h1>
              <p className="mt-2 max-w-3xl text-blue-100">
                Your main control page for patient load, upcoming sessions, and fast access to the most important actions.
              </p>
            </div>
          </div>
          <div className="rounded-3xl bg-white/10 px-5 py-4 backdrop-blur">
            <p className="text-xs uppercase tracking-[0.25em] text-blue-100">Priority queue</p>
            <p className="mt-2 text-2xl font-bold">{screeningQueue.length} reviews</p>
            <p className="mt-1 text-sm text-blue-100">Patients waiting for screening or follow-up review</p>
          </div>
        </div>
      </section>
      ...
      <div className="grid gap-5 xl:grid-cols-[1.05fr_0.95fr]">
        ...
        <section className="space-y-5">
          ...
          <section className="card rounded-[2rem] border border-[var(--border)] shadow-lg">
            <h2 className="text-xl font-bold text-[var(--ink)]">Screening queue</h2>
