      ...
      <section className="rounded-[2rem] bg-gradient-to-r from-blue-900 via-blue-800 to-sky-700 p-6 text-white shadow-2xl sm:p-8">
        <div className="flex flex-col gap-4 xl:flex-row xl:items-center xl:justify-between">
          ...
          <div className="rounded-3xl bg-white/10 px-5 py-4 backdrop-blur">
            ...
            <p className="mt-2 text-2xl font-bold">{assessmentQueue.length} reviews</p>
            <p className="mt-1 text-sm text-blue-100">Patients waiting for assessment or follow-up review</p>
          </div>
        </div>
      </section>
