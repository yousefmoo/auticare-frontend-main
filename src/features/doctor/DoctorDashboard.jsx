...
const upcomingAppointments = [
  ...
  { id: 2, patient: 'Emma Davis', time: '11:30 AM', type: 'Assessment', therapist: 'Dr. Johnson' },
...
const quickActions = [
  ...
  { icon: Calendar, label: 'Schedule', path: '/doctor/assessments', color: 'bg-emerald-600' },
...
const activityFeed = [
  ...
  { id: 2, label: 'New assessment uploaded for Emma Davis', time: '4 hours ago' },
