...
const roleActionConfig = {
  doctor: {
    ...
    secondaryAction: { label: 'Open Screenings', to: '/doctor/screening' },
  ...
  therapist: {
    ...
    partnerTitle: 'Connected with',
    partners: [
      { label: 'Doctor direction', value: 'Treatment goals, screenings, review points', icon: Stethoscope },
  ...
  parent: {
    ...
    partnerTitle: 'Connected with',
    partners: [
      { label: 'Doctor review', value: 'Screening follow-up, report explanation, plan changes', icon: Stethoscope },
        ...
        <section className="space-y-6">
          ...
          <div className="card rounded-[2rem] shadow-lg">
            ...
            <div className="mt-5 space-y-3 text-sm text-[var(--muted)]">
              ...
              <div className="rounded-2xl border border-[var(--border)] p-4">
                Plans, notes, feedback, and screenings complete the same shared communication loop.
              </div>
              <Link
                to={roleActions.liveCall.to}
