...
export default function Signup() {
  ...
  const onSubmit = async (formData) => {
    try {
      ...
      setSubmitMessage(`Account created for ${formData.role}. Signing you in...`)

      // Auto login after successful registration
      const responseData = await loginAPI(formData.email, formData.password)
      
      // authStore.login handles the role normalization and caching
      login(responseData, { remember: true })

      // Use the normalized role from the store for immediate redirect
      ...
      addToast({
        ...
        message: `Welcome to AutiCare! You are signed in as ${userRole}.`,
      })
