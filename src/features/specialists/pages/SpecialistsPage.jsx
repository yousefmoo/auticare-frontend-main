...
import { specialistDirectory } from '../../dashboard/portalData'
...
export default function SpecialistsPage() {
  ...
  return (
    <div className="fade-in space-y-6">
      <PageHeader
        title="Specialists"
        subtitle="Browse doctors and therapists, review their specialization and experience, and start the next care action fast."
      />
