        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <div className="space-y-2 text-sm">
              ...
              <NavLink to="/sessions" className="block text-[var(--muted)] hover:text-[var(--ink)]">Sessions</NavLink>
              <NavLink to="/questionnaire" className="block text-[var(--muted)] hover:text-[var(--ink)]">Get Started</NavLink>
